// //alimentar botão tipo select box 
...
//             console.log('Curso' + lista_cursos[a].titulo + 'tem media de avaliações: '+ media.toFixed(2));
...
function pegar_pergunta(callback) {
    ...
    $.ajax({
        url: "https://opentdb.com/api.php?amount=10&category=11", //endereço da API
